...
-  [4.Program Construction Guide](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#4-program-construction-guide)
   - [4.1. Camera Program Guide](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#41-camera-program-guide)
        * [TEP 1. Gathering Necessary Components](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-1-gathering-necessary-components)
        * [STEP 2. Hardware Connections](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-2-hardware-connections)
        * [STEP 3. Installing Arduino IDE](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-3-installing-arduino-ide)
        * [STEP 4. Configuring the Arduino IDE](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-4-configuring-the-arduino-ide)
        * [STEP 5. Selecting Board and Port](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-5-selecting-board-and-port)
        * [STEP 6. Loading Sample Code](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-6-loading-sample-code)
        * [STEP 7. Uploading the Code](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-7-uploading-the-code)
        * [STEP 8. Running the Program](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-8-running-the-program)
        * [STEP 9. Troubleshooting](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-9-troubleshooting)
   - [4.2. ESP32 Program Guide](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#42-esp32-program-guide)
        * [Folder Structure](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#folder-structure)
        * [Prerequisites](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#prerequisites)
        * [Step 1. Set Up Arduino IDE for ESP32](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-1-set-up-arduino-ide-for-esp32)
        * [Step 2. Install Required Libraries](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-2-install-required-libraries)
        * [Step 3. Open and Upload the Program](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#step-3-open-and-upload-the-program)
        * [Common Issues & Troubleshooting](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#common-issues--troubleshooting)
        * [References](https://github.com/Sharmainne/CZSHS-LEIBNIZ-Team?tab=readme-ov-file#references)
...
[Watch demo on YouTube]([https://www.youtube.com/watch?v=abcd1234](https://youtu.be/NMx7oAEPLlU)
